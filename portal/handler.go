...
func (studentsHandler) renderStudents(w http.ResponseWriter, _ *http.Request) {
	var err error
	defer func() {
		if err != nil {
...
func (studentsHandler) renderStudent(w http.ResponseWriter, _ *http.Request, id int) {
